...
filename_version = os.path.join(__dir__, '..', 'VERSION.conf')
f_version = open(filename_version, 'r')
version_AB = f_version.readline().strip().replace('"', '').split('=')[1]
#version_AB = '2021_07'
sys.stderr.write('AB version: %s\n' % version_AB)
